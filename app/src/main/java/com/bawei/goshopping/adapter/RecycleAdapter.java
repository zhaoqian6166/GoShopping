...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyViewHolder> {
   private  List<Zqbean.DataBean.BestSellersBean.GoodsListBeanX> list;
    private  List<String> goodsIdsList;
    private LayoutInflater inflater;
    private Context context;

    public RecycleAdapter(List<Zqbean.DataBean.BestSellersBean.GoodsListBeanX> list,Context context, List<String> goodsIdsList) {
        this.list = list;
